...
- [虚拟机和容器](virtual-machines.md)
- [Shell 编程和脚本](shell.md)

## 周四，1 月 17 日

- [命令行环境](command-line.md)
- [数据整理](data-wrangling.md)
...
- [点文件（Dotfiles）](dotfiles.md)
- [备份](backups.md)
- [自动化](automation.md)
- [机器自省](machine-introspection.md)

## 周二，1 月 29 日

- [程序自省](program-introspection.md)
- [软件包管理](package-management.md)
- [操作系统自定义](os-customization.md)
- [远程机器](remote-machines.md)
...
我们也将这个课程分享给了 MIT 之外的人，希望其他人也能从这些资源中受益。你可以在以下位置找到帖子和讨论：
